...
const PrivacyPage = () => {
  return (
    <article className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <section>
        <p>This privacy policy applies to the pico cards app (hereby referred to as "Application") for mobile devices that was created by Poshet (hereby referred to as "Service Provider") as a Commercial service. This service is intended for use "AS IS".</p>
      </section>
      ...
      <section>
        <p>For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information, including but not limited to Email, payment information. The information that the Service Provider request will be retained by them and used as described in this privacy policy.</p>
      </section>
      ...
      <section>
        ...
        <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you&apos;d like them to delete User Provided Data that you have provided via the Application, please contact them at ybahaerarslan@gmail.com and they will respond in a reasonable time.</p>
      </section>
      ...
      <section>
        ...
        <p className="mt-4">This privacy policy is effective as of 2025-02-25</p>
      </section>
      ...
      <section>
        ...
        <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at ybahaerarslan@gmail.com.</p>
      </section>
